...
export const alias: Record<string, string> = {
  ...
  '@types': pathResolve('../packages/types'),
  '@assets': pathResolve('../apps/admin/src/assets'),
  '@components': pathResolve('../apps/admin/src/components'),
  '@views': pathResolve('../apps/admin/src/views'),
  '@utils': pathResolve('../packages/core/utils'),
  '@stores': pathResolve('../packages/core/stores'),
  '@router': pathResolve('../packages/core/router'),
  '@api': pathResolve('../packages/core/api'),
  '@hooks': pathResolve('../apps/admin/src/hooks'),
  '@common': pathResolve('../apps/admin/src/common'),
  '@test': pathResolve('../apps/admin/src/views/test'),
...
export const wrapperEnv = (envConf: Record<string, unknown>): ViteEnv => {
  ...
  const ret: ViteEnv = {
    ...
    VITE_APP_TITLE: 'early-bird',
    VITE_APP_VERSION: '1.0.0',
    VITE_APP_ENV: 'development',
    VITE_PINIA_PERSIST_KEY_PREFIX: 'early-bird',
